...
<template>
  <div class="pb-10">
    <div class="card mb-2 flex items-center justify-between">
      <h2 class="text-xl font-bold py-2">{{ supplyInfo.organization.name }}</h2>
    ...
    >
      <div class="py-2">
        ...
        <div class="flex flex-col items-end">
          <label for="apply">
            <input type="checkbox" class="hidden" id="apply" v-model="supply.provide.applyCheck">
  ...
  <div class="fixed bg-white left-0 right-0 bottom-0 py-2 px-3 border flex items-center justify-between">
    ...
    <div>
      <router-link class="btn btn-outline mr-2" to="/">取消</router-link>
      <button class="btn">確認申請</button>
    </div>
  </div>
</template>
